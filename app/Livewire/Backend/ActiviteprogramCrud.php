...
class ActiviteprogramCrud extends Component
{
    ...
    protected $rules = [
        ...
        'image1' => 'nullable|image|mimes:jpg,jpeg,png,gif,webp|max:2048',
        'image2' => 'nullable|image|mimes:jpg,jpeg,png,gif,webp|max:2048',
        'image3' => 'nullable|image|mimes:jpg,jpeg,png,gif,webp|max:2048',
