<div>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#doyenneModal" style="flex: 0 0 25%;">
        ...
        <div class="modal fade" id="doyenneModal" tabindex="-1" aria-labelledby="doyenneModalLabel" aria-hidden="true" wire:ignore.self>
                    ...
                    <form wire:submit.prevent="{{ $editMode ? 'updateDoyenne' : 'addDoyenne' }}">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="localisation" wire:model.live="localisation"
                            ...
                            <div class="row">
                                  <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nombreaproximatifmembre" class="form-label">Nombre approximatif de membres</label>
                                        <input type="number" class="form-control" id="nombreaproximatifmembre" wire:model.live="nombreaproximatifmembre"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="responsable" wire:model.live="responsable"
                        ...
                        <span wire:loading.remove wire:target="{{ $editMode ? 'updateDoyenne' : 'addDoyenne' }}">
